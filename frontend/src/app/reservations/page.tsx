                    ...
                    {(reservation.status ===
                      ...
                      activeTab ===
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 text-red-400 hover:text-red-300 disabled:opacity-50 text-sm font-medium px-3 py-1.5 rounded-lg hover:bg-red-900/20 transition whitespace-nowrap"
                        >
