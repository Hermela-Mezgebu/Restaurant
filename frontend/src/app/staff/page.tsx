...
export default function StaffPage() {
  ...
  return (
    ...
    >
      ...
      <aside
        className="fixed left-0 top-0 h-full w-64 z-50 hidden lg:flex flex-col justify-between border-r"
        style={{
      ...
      >
        <div className="flex flex-col">
          ...
          <div className="px-2 pt-3">
            <div
              className="px-4 pb-2 text-[10px] uppercase tracking-wider font-semibold"
              style={{ color: COLORS.outline }}
            >
              Floor Management
            </div>
          ...
          <div className="w-full px-5 lg:px-16 py-6">
            ...
            {activeTab === "tables" && (
              <TablesTab
                ...
                occupiedCount={occupiedTableCount}
                reservedCount={reservedTableCount}
                onOpenTable={(table) => setSelectedTable(table)}
